  ...
  module LocationAuditor # :nodoc:
    ...
    module AuditedInstanceMethods
      ...
      def own_and_associated_audits
        LocationAudited.audit_class.unscoped.where(auditable: self)
          .or(LocationAudited.audit_class.unscoped.where(associated: self))
      ...
      def normalize_enum_changes(changes)
        return changes if LocationAudited.store_synthesized_enums
    ...
    module AuditedClassMethods
      ...
      def auditing_enabled
        class_auditing_enabled && LocationAudited.auditing_enabled
      end
      ...
      def class_auditing_enabled
        LocationAudited.store.fetch("#{table_name}_auditing_enabled", true)
      end
    end
  end
end
